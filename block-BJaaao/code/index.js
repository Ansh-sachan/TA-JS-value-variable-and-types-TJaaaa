...
alert(`THe value of num1 is ${num1} an the value of num2 is ${num2}`)
...
*/
  ...
  let userProfession=prompt("Enter your proffesion");
...
const numA = parseInt(prompt("enter one number"));
 const numB = parseInt(prompt("enter second number"));
 const sum = numA+numB
 alert(sum)
 alert (`${numA-numB}`)
 alert (`${numA*numB}`)
